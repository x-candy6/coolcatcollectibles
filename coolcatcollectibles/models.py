...
class Product(models.Model):
    ...
    publisher_name = models.CharField(db_column='Publisher_Name', max_length=50, blank=True, null=True)  # Field name made lowercase.
    series_name = models.CharField(db_column='Series_Name', max_length=128, blank=True, null=True)  # Field name made lowercase.
    full_title = models.CharField(db_column='Full_Title', max_length=256, blank=True, null=True)  # Field name made lowercase.
    ...
    in_collection = models.IntegerField(db_column='In_Collection', blank=True, null=True)  # Field name made lowercase.
