...
// GET request with custom headers, accepts the endpoint and a dict of headers
const getReqWithHeaders = async (url, customheaders) => {
    try {
        console.log("grwh:", customheaders)
...
export default {fetchData, updateData, searchData, postData, getData, setAuthToken, getReqWithHeaders} ;